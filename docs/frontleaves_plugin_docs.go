...
const docTemplatefrontleaves_plugin = `{
        ...
        "/admin/economy/balance/adjust": {
            "post": {
                ...
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/economy.AdjustBalanceResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "503": {
                        "description": "服务不可用（MC 插件未连接或查询超时）",
                        "schema": {
                            "$ref": "#/definitions/xBase.BaseResponse"
                        }
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/apiMatrixStatistic.StatisticResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/apiMatrixWarning.WarningListResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/apiMatrixWarning.WarningDetailResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "apiMatrixStatistic.StatisticResponse": {
            "type": "object",
            "properties": {
                "blocks_break": {
                    "type": "array",
        ...
        "apiMatrixWarning.WarningDetailResponse": {
            "type": "object",
            "properties": {
                "context_data": {
                    "type": "array",
        ...
        "apiMatrixWarning.WarningListItemResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "apiMatrixWarning.WarningListResponse": {
            "type": "object",
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/apiMatrixWarning.WarningListItemResponse"
                    }
                },
                "page": {
                    "type": "integer"
        ...
        "economy.AdjustBalanceRequest": {
            ...
            "properties": {
                "amount": {
                    "description": "操作金额（单位：元，reset时忽略）",
                    "type": "number"
                },
                "operation": {
                    "description": "操作类型：add/remove/set/reset",
                    "type": "string"
                },
                "player_uuid": {
                    "description": "玩家UUID",
