...
# ============================================================================
# FrontLeaves Plugin Docker 构建脚本 (Frontleaves - Phalanx Labs)
# 使用 gum 美化输出
# ============================================================================
...
print_banner() {
    if [ "$USE_GUM" = true ]; then
        ...
        echo -e "${BLUE}  _____  _             _             ____ _               ${NC}"
        echo -e "${BLUE} |  __ \\(_)           | |           / ____| |              ${NC}"
        echo -e "${BLUE} | |__) |_  __ _  ___| |_ _   _   | (___ | |__   ___ _ __ ${NC}"
        echo -e "${BLUE} |  ___/| |/ _\` |/ __| __| | | |   \\___ \\| '_ \\ / _ \\ '__|${NC}"
        echo -e "${BLUE} | |    | | (_| | (__| |_| |_| |   ____) | | | |  __/ |   ${NC}"
        echo -e "${BLUE} |_|    |_|\\__,_|\\___|\\__|\\__, |  |_____/|_| |_|\\___|_|   ${NC}"
        echo -e "${BLUE}                           __/ |                         ${NC}"
        echo -e "${BLUE}                          |___/                          ${NC}"
        echo ""
        echo -e "${BLUE}     FrontLeaves Plugin Service${NC}"
        echo ""
...
if command -v swag &> /dev/null; then
    ...
    if swag init --instanceName frontleaves_plugin -g main.go --parseDependency 2>/dev/null; then
