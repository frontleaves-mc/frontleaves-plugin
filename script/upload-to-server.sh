...
print_banner() {
    if [ "$USE_GUM" = true ]; then
        gum style \
            ...
            "  _____  _             _             ____ _               " \
            " |  __ \\(_)           | |           / ____| |              " \
            " | |__) |_  __ _  ___| |_ _   _   | (___ | |__   ___ _ __ " \
            " |  ___/| |/ _\` |/ __| __| | | |   \\___ \\| '_ \\ / _ \\ '__|" \
            " | |    | | (_| | (__| |_| |_| |   ____) | | | |  __/ |   " \
            " |_|    |_|\\__,_|\\___|\\__|\\__, |  |_____/|_| |_|\\___|_|   " \
            "                           __/ |                         " \
            "                          |___/                          " \
            "" \
            "       FrontLeaves Plugin Service         " \
            "" \
            "        Server Upload Script v1.0 💚"
    else
        echo -e "\033[0;32m  _____  _             _             ____ _               \033[0m"
        echo -e "\033[0;32m |  __ \\(_)           | |           / ____| |              \033[0m"
        echo -e "\033[0;32m | |__) |_  __ _  ___| |_ _   _   | (___ | |__   ___ _ __ \033[0m"
        echo -e "\033[0;32m |  ___/| |/ _\` |/ __| __| | | |   \\___ \\| '_ \\ / _ \\ '__|\033[0m"
        echo -e "\033[0;32m | |    | | (_| | (__| |_| |_| |   ____) | | | |  __/ |   \033[0m"
        echo -e "\033[0;32m |_|    |_|\\__,_|\\___|\\__|\\__, |  |_____/|_| |_|\\___|_|   \033[0m"
        echo -e "\033[0;32m                           __/ |                         \033[0m"
        echo -e "\033[0;32m                          |___/                          \033[0m"
        echo ""
        echo -e "\033[0;32m     FrontLeaves Plugin Service\033[0m"
        echo ""
...
DEFAULT_DEPLOY_PATH="/root/frontleaves-plugin"
...
if [ -z "$DEPLOY_SERVER" ]; then
    ...
    echo "  ./script/upload-to-server.sh your-server.com root /opt/1panel/www/sites/plugin/index"
    echo ""
    exit 1
fi
